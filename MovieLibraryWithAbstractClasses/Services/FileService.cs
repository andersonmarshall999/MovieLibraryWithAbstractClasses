...
namespace MovieLibraryWithAbstractClasses.Services
{
    public class FileService : IFileService
    {
        ...
        public List<int> ShowSeasons { get; set; }
        public List<int> ShowEpisodes { get; set; }
        ...
        public List<int> VideoLengths { get; set; }
        ...
        // TODO: new media cant be input unless Write() method is used first
        // TODO: files are reset upon rerunning program
    }
}